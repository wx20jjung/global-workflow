...
IASINGBF=${IASINGBF:-${COM_OBS}/${OPREFIX}mtiasing.tm00.bufr_d${OSUFFIX}}
ESIASING=${ESIASING:-${COM_OBS}/${OPREFIX}esiasing.tm00.bufr_d${OSUFFIX}}
IASINGDB=${IASINGDB:-${COM_OBS}/${OPREFIX}iasingdb.tm00.bufr_d${OSUFFIX}}
