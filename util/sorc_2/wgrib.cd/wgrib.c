...
extern  struct ParmTable parm_table_nceptab_128[256];
...
extern  struct ParmTable parm_table_ecmwf_172[256];
...
extern  struct ParmTable parm_table_dwd_204[256];
extern  struct ParmTable parm_table_dwd_205[256];
...
struct ParmTable parm_table_nceptab_128[256] = {
      /* 0 */ {"var0", "undefined"},
      /* 1 */ {"PRES", "Pressure [Pa]"},
      /* 2 */ {"PRMSL", "Pressure reduced to MSL [Pa]"},
      /* 3 */ {"PTEND", "Pressure tendency [Pa/s]"},
...
struct ParmTable parm_table_ecmwf_172[256] = {
    /* 0 */ {"var0", "undefined"},
    /* 1 */ {"var1", "undefined"},
    /* 2 */ {"var2", "undefined"},
    /* 3 */ {"var3", "undefined"},
...
struct ParmTable parm_table_dwd_204[256] = {
    /* 0 */ {"var0", "undefined"},
...
struct ParmTable parm_table_dwd_205[256] = {
    /* 0 */ {"var0", "undefined"},
