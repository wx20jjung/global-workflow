...
C$$$
      ...
      INTEGER KPDSB(200),KGDSB(200),KENSB(5)
      INTEGER KPDSM(200),KGDSM(200),KENSM(5)
      INTEGER,POINTER :: TMPPTR(:)=>NULL()
      LOGICAL*1 LR(MF)
      LOGICAL*1,POINTER :: L1I(:)=>NULL()
      LOGICAL*1,POINTER :: LBI(:)=>NULL()
      LOGICAL UNPACK
      REAL FR(MF)
      REAL GR(MF)
      REAL,POINTER :: F1I(:)=>NULL()
      REAL,POINTER :: G1I(:)=>NULL()
      REAL,POINTER :: FBI(:)=>NULL()
      REAL,POINTER :: GBI(:)=>NULL()
...
C  CLEAN UP - FREE MEMORY
      ...
      CALL GF_FREE(GFLDM)
      CALL GF_FREE(GFLDMV)
!JAJ      IF (ASSOCIATED(L1I)) DEALLOCATE(L1I)
!JAJ      IF (ASSOCIATED(F1I)) DEALLOCATE(F1I)
!JAJ      IF (ASSOCIATED(G1I)) DEALLOCATE(G1I)
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      END
C-----------------------------------------------------------------------
